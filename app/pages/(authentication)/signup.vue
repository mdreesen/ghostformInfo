        ...
        <main class="w-full max-w-120 z-10">
            <div class="backdrop-blur-2xl bg-white/2 border border-white/8 rounded-[2.5rem] p-10 shadow-2xl">
                ...
                <header class="mb-10">
                    ...
                    <p class="text-zinc-400 text-sm italic-none">Join the network of high-velocity real estate
                        intelligence.</p>
                </header>
                ...
                <div class="space-y-6">
                    ...
                    <div class="relative flex items-center py-4">
                        ...
                        <span
                            class="shrink mx-4 text-zinc-600 text-[9px] uppercase tracking-[0.3em] font-black">Preferences</span>
                        <div class="grow border-t border-white/5"></div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select v-model="formData.role"
                                class="w-full bg-[#121214] border border-white/10 rounded-xl px-5 py-3 text-sm focus:outline-none focus:border-[#30cf43]/50 transition-colors text-zinc-300">
                    ...
                    <p class="text-center text-xs text-zinc-500">
                        Already have a node? <NuxtLink to="/login" class="text-[#30cf43] hover:underline">Access Login
                        </NuxtLink>
                    </p>
                </div>
            </div>
