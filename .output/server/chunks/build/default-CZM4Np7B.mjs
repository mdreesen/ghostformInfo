import { k as useRoute, u as useHead, _ as __nuxt_component_0$2, l as __nuxt_component_1$1 } from './server.mjs';
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/base/Navigation/Base.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const __nuxt_component_0 = Object.assign(_sfc_main$2, { __name: "BaseNavigationBase" });
const _sfc_main$1 = {};
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_baseNavigationBase = __nuxt_component_0;
      ...
      _push(ssrRenderComponent(_component_baseNavigationBase, null, null, _parent));
      _push(`<div>`);
...
//# sourceMappingURL=default-CZM4Np7B.mjs.map
