import { S as __nuxt_component_1$1$1, _ as __nuxt_component_0$2, Q as __nuxt_component_0$1$1 } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_nuxt_link, mergeProps({ to: __props.path }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="w-full md:w-auto px-10 py-5 bg-cyan-500 hover:bg-cyan-700 hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-900&#39;} w-full rounded-xl py-3 text-lg font-semibold text-white shadow-lg transition-all duration-300 ease-in-out"${_scopeId}>${ssrInterpolate(__props.text)}</button>`);
          } else {
            return [
              createVNode("button", { class: "w-full md:w-auto px-10 py-5 bg-cyan-500 hover:bg-cyan-700 hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-900'} w-full rounded-xl py-3 text-lg font-semibold text-white shadow-lg transition-all duration-300 ease-in-out" }, toDisplayString(__props.text), 1)
            ];
          }
        }),
        _: 1
...
const __nuxt_component_1$2 = Object.assign(_sfc_main$7, { __name: "BaseButtonNavigate" });
const _sfc_main$6 = {};
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-f4825f21"]]), { __name: "AppHero" });
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(tiers, (tier) => {
        ...
        _push(`<!--]--></ul><a href="https://ghostform-dashboard.vercel.app/signup"><button class="${ssrRenderClass([
        ...
        ])}">${ssrInterpolate(tier.cta)}</button></a></div>`);
      });
      _push(`<!--]--></div></section>`);
    };
  }
...
//# sourceMappingURL=index-CwZO6blR.mjs.map
