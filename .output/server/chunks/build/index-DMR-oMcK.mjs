import { b as useNuxtData, a as useUserSession, _ as __nuxt_component_0$2 } from './server.mjs';
...
const dependencies = { "@nuxt/image": "^1.11.0", "@nuxt/kit": "^4.2.2", "@nuxt/ui": "^4.3.0", "@nuxtjs/tailwindcss": "^6.14.0", "@pinia/nuxt": "^0.11.3", "@tailwindcss/vite": "^4.1.13", "@vite-pwa/nuxt": "^1.0.4", "@vueuse/motion": "^3.0.3", "bcrypt": "^6.0.0", "date-fns": "^4.1.0", "lucide-vue-next": "^0.556.0", "mongodb": "^6.21.0", "mongoose": "^8.23.1", "nuxt": "^4.2.2", "nuxt-auth-utils": "^0.5.25", "nuxt-charts": "^0.2.4", "nuxt-google-auth": "^0.1.7", "nuxt-notify": "^1.1.4", "nuxt-vitalizer": "^2.0.0", "pinia": "^3.0.4", "reka-ui": "^2.6.1", "resend": "^6.12.3", "tailwindcss": "^4.1.13", "vue": "^3.5.21", "vue-router": "^4.5.1", "zod": "^4.4.3" };
...
//# sourceMappingURL=index-DMR-oMcK.mjs.map
