...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList({ "Total Intake": (_e = (_d = (_c = unref(user)) == null ? void 0 : _c.leads) == null ? void 0 : _d.length) != null ? _e : 0, "Active Leads": "WIP", "Conversion": "WIP" }, (val, label) => {
      ...
      _push(ssrRenderComponent(_component_baseTable, {
        data: (_f = unref(user)) == null ? void 0 : _f.leads
      }, null, _parent));
...
//# sourceMappingURL=index-DsCvdecn.mjs.map
