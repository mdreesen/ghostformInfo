...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen" }, _attrs))} data-v-2350ff0c><main class="max-w-7xl mx-auto h-svh px-4 grid grid-cols-1 gap-8 items-center content-center pb-24" data-v-2350ff0c><div class="relative" data-v-2350ff0c>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2350ff0c"]]);

export { index as default };
//# sourceMappingURL=index-yPJcF1Rj.mjs.map
