...
import { b as useNuxtData } from './server.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({ class: "w-full md:w-auto px-10 py-5 bg-cyan-500 hover:bg-cyan-700 hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-900'} w-full rounded-xl py-3 text-lg font-semibold text-white shadow-lg transition-all duration-300 ease-in-out" }, _attrs))}>${ssrInterpolate(__props.text)}</button>`);
    };
  }
});
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="flex gap-4"><div class="px-6 py-3 backdrop-blur-xl bg-white/3 border border-white/8 rounded-2xl"><span class="text-[8px] font-bold text-zinc-500 uppercase block mb-1">High Velocity (Tier 1)</span><span class="text-2xl font-black text-[#30cf43]">14</span></div>`);
...
//# sourceMappingURL=index-CqG6qZoL.mjs.map
