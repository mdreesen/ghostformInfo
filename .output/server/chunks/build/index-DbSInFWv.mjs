...
import { _ as __nuxt_component_6 } from './Table-Blsei8Kv.mjs';
import 'vue-router';
import '@iconify/vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen py-20 p-6 lg:py-18 relative overflow-hidden" }, _attrs))} data-v-c6c59d4a><div class="absolute top-0 right-0 w-150 h-150 bg-cyan-400 rounded-full blur-[200px] opacity-[0.03]" data-v-c6c59d4a></div><header class="max-w-350 mx-auto flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-6 relative z-10" data-v-c6c59d4a><div data-v-c6c59d4a><div class="flex items-center gap-3 mb-2" data-v-c6c59d4a>`);
      ...
      _push(`</div><div class="flex gap-4" data-v-c6c59d4a>`);
      ...
      _push(`</div></header><main class="max-w-350 mx-auto relative z-10" data-v-c6c59d4a><section class="flex flex-wrap justify-around gap-6 mb-12" data-v-c6c59d4a><!--[-->`);
      ssrRenderList({ "Total Intake": unref(user)?.leads?.length ?? 0, "Active Leads": "WIP", "Conversion": "WIP" }, (val, label) => {
        _push(`<div class="backdrop-blur-xl bg-white/2 border border-white/8 p-8 rounded-3xl w-full sm:w-62.5" data-v-c6c59d4a><p class="text-[10px] font-bold uppercase tracking-widest text-zinc-500 mb-4" data-v-c6c59d4a>${ssrInterpolate(label)}</p><p class="text-3xl font-bold tabular-nums" data-v-c6c59d4a>${ssrInterpolate(val)}</p></div>`);
      });
      _push(`<!--]--></section><div class="flex w-full" data-v-c6c59d4a><div class="space-y-6 w-full" data-v-c6c59d4a><div class="flex justify-between items-end mb-4" data-v-c6c59d4a>`);
      _push(ssrRenderComponent(_component_baseHeaderSection, { text: "Lead Tracking" }, null, _parent));
      _push(`</div><div class="backdrop-blur-xl bg-white/2 border border-white/8 rounded-[2.5rem] overflow-hidden w-full" data-v-c6c59d4a>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c6c59d4a"]]);

export { index as default };
//# sourceMappingURL=index-DbSInFWv.mjs.map
