...
import { ssrRenderAttrs, ssrGetDirectiveProps, ssrRenderComponent, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderClass, ssrInterpolate, ssrRenderVNode, ssrRenderSlot } from 'vue/server-renderer';
import { a as useUserSession, d as useMotion, i as _sfc_main$8, _ as __nuxt_component_0$2, j as __nuxt_component_5, e as useAppConfig, f as useComponentUI, g as useForwardPropsEmits, r as reactivePick, h as usePortal, t as tv, V as VisuallyHidden_default } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex items-center justify-center py-20 relative overflow-hidden" }, _attrs))} data-v-c9f46dda><main class="w-full max-w-110 z-10" data-v-c9f46dda><div class="backdrop-blur-xl bg-white/3 border border-white/8 rounded-3xl p-10 shadow-2xl" data-v-c9f46dda><header class="text-center mb-12" data-v-c9f46dda><div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-linear-to-br from-[#30cf43] to-[#15a327] mb-6 shadow-[0_0_30px_rgba(48,207,67,0.4)]" data-v-c9f46dda><svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-c9f46dda><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A10.003 10.003 0 0012 3c1.72 0 3.347.433 4.774 1.202m.38 11.21a10.001 10.001 0 003.858-5.808l.047-.204" data-v-c9f46dda></path></svg></div><h1 class="text-3xl font-bold tracking-tight text-white mb-2" data-v-c9f46dda>GhostForm</h1><p class="text-zinc-400 text-sm" data-v-c9f46dda>Intelligence for the Unseen.</p></header><div class="space-y-6" data-v-c9f46dda><form class="space-y-6" data-v-c9f46dda><div${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_motion, { ...unref(inputVarient)() }))} data-v-c9f46dda>`);
      _push(ssrRenderComponent(_component_baseLabel, { text: "Email" }, null, _parent));
      _push(`<input id="email" type="email"${ssrRenderAttr("value", credentials.email)} placeholder="Email" required class="w-full rounded-xl border border-gray-600 bg-gray-700/50 py-3 px-4 text-lg text-white shadow-lg transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500" data-v-c9f46dda></div><div${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_motion, { ...unref(inputVarient)() }))} data-v-c9f46dda>`);
      _push(ssrRenderComponent(_component_baseLabel, { text: "Password" }, null, _parent));
      _push(`<input id="password" type="password"${ssrRenderAttr("value", credentials.password)} placeholder="Password" required class="w-full rounded-xl border border-gray-600 bg-gray-700/50 py-3 px-4 text-lg text-white shadow-lg transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500" data-v-c9f46dda></div><div${ssrRenderAttrs(mergeProps({ class: "flex flex-col items-center justify-center w-full mx-auto font-sans" }, ssrGetDirectiveProps(_ctx, _directive_motion, { ...unref(inputVarient)() })))} data-v-c9f46dda><div class="w-full relative flex justify-end" data-v-c9f46dda>`);
      _push(ssrRenderComponent(_component_UDrawer, {
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form class="space-y-6" data-v-c9f46dda${_scopeId}><div${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_motion, { ...unref(inputVarient)() }))} data-v-c9f46dda${_scopeId}>`);
            ...
            _push2(`<input id="question" type="text"${ssrRenderAttr("value", input.question)} placeholder="What is 4 + 3" required class="w-full rounded-xl border border-gray-600 bg-gray-700/50 py-3 px-4 text-lg text-white shadow-lg transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500" data-v-c9f46dda${_scopeId}></div><div class="flex flex-col gap-8 pb-4" data-v-c9f46dda${_scopeId}>`);
      ...
      _push(`<div class="relative flex items-center py-2" data-v-c9f46dda><div class="grow border-t border-white/10" data-v-c9f46dda></div><span class="shrink mx-4 text-zinc-500 text-[10px] uppercase tracking-widest font-bold" data-v-c9f46dda>Encrypted Session</span><div class="grow border-t border-white/10" data-v-c9f46dda></div></div><p class="text-center text-xs text-zinc-500 leading-relaxed" data-v-c9f46dda> Authorized personnel only. Sessions are logged and analyzed for regional compliance. </p></div></div><footer class="mt-8 flex justify-between items-center px-4" data-v-c9f46dda><div class="flex items-center gap-2" data-v-c9f46dda><div class="w-1.5 h-1.5 rounded-full bg-[#30cf43] shadow-[0_0_8px_#30cf43]" data-v-c9f46dda></div><span class="text-[10px] font-bold text-zinc-500 uppercase tracking-widest" data-v-c9f46dda>Ghost-Node Active</span></div><span class="text-[10px] font-mono text-zinc-600 italic-none" data-v-c9f46dda>v3.0.4-LITE</span></footer></main></div>`);
    };
  }
});
...
const login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c9f46dda"]]);

export { login as default };
//# sourceMappingURL=login-BU3soqDc.mjs.map
