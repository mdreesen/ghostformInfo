...
import { b as useUserSession, R as useMotion, F as _sfc_main$8, _ as __nuxt_component_0$2, w as useAppConfig, x as useComponentUI, y as useForwardPropsEmits, z as reactivePick, B as usePortal, D as tv, V as VisuallyHidden_default } from './server.mjs';
...
import { u as useToast } from './useToast-Bo4qvy99.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex items-center justify-center py-20 relative overflow-hidden" }, _attrs))} data-v-fcf419b0><main class="w-full max-w-110 z-10" data-v-fcf419b0><div class="backdrop-blur-xl bg-white/3 border border-white/8 rounded-3xl p-10 shadow-2xl" data-v-fcf419b0><header class="text-center mb-12" data-v-fcf419b0><h1 class="text-3xl font-bold tracking-tight text-white mb-2" data-v-fcf419b0>GhostForm</h1><p class="text-zinc-400 text-sm" data-v-fcf419b0>Intelligence for the Unseen.</p></header><div class="space-y-6" data-v-fcf419b0><form class="space-y-6" data-v-fcf419b0><div${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_motion, { ...unref(inputVarient)() }))} data-v-fcf419b0>`);
      _push(ssrRenderComponent(_component_baseLabel, { text: "Email" }, null, _parent));
      _push(`<input id="email" type="email"${ssrRenderAttr("value", credentials.email)} placeholder="Email" required class="w-full bg-white/3 border border-white/10 rounded-xl px-5 py-3 text-sm focus:outline-none focus:border-cyan-400 transition-colors placeholder:text-zinc-700 text-ellipsis" data-v-fcf419b0></div><div${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_motion, { ...unref(inputVarient)() }))} data-v-fcf419b0>`);
      _push(ssrRenderComponent(_component_baseLabel, { text: "Password" }, null, _parent));
      _push(`<input id="password" type="password"${ssrRenderAttr("value", credentials.password)} placeholder="Password" required class="w-full bg-white/3 border border-white/10 rounded-xl px-5 py-3 text-sm focus:outline-none focus:border-cyan-400 transition-colors placeholder:text-zinc-700 text-ellipsis" data-v-fcf419b0></div><div${ssrRenderAttrs(mergeProps({ class: "flex flex-col items-center justify-center w-full mx-auto" }, ssrGetDirectiveProps(_ctx, _directive_motion, { ...unref(inputVarient)() })))} data-v-fcf419b0><div class="w-full relative flex justify-end" data-v-fcf419b0>`);
      _push(ssrRenderComponent(_component_UDrawer, {
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form class="space-y-6" data-v-fcf419b0${_scopeId}><div${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_motion, { ...unref(inputVarient)() }))} data-v-fcf419b0${_scopeId}>`);
            ...
            _push2(`<input id="question" type="text"${ssrRenderAttr("value", input.question)} placeholder="What is 4 + 3" required class="w-full bg-white/3 border border-white/10 rounded-xl px-5 py-3 text-sm focus:outline-none focus:border-cyan-400 transition-colors placeholder:text-zinc-700 text-ellipsis" data-v-fcf419b0${_scopeId}></div><div class="flex flex-col gap-8 pb-4" data-v-fcf419b0${_scopeId}>`);
      ...
      _push(`</div></div><div${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_motion, { ...unref(inputVarient)() }))} data-v-fcf419b0>`);
      _push(ssrRenderComponent(_component_baseButtonSubmit, {
        text: "Log in",
        isLoading: isLoading.value
      }, null, _parent));
      _push(`</div></form><div${ssrRenderAttrs(mergeProps({ class: "relative flex items-center justify-center py-4" }, ssrGetDirectiveProps(_ctx, _directive_motion, { ...unref(inputVarient)() })))} data-v-fcf419b0><div class="absolute w-full border-t border-gray-700" data-v-fcf419b0></div><span class="relative z-10 bg-gray-800/80 backdrop-blur-md px-4 text-gray-400 text-sm" data-v-fcf419b0>OR</span></div><div${ssrRenderAttrs(mergeProps({ class: "text-center" }, ssrGetDirectiveProps(_ctx, _directive_motion, { ...unref(inputVarient)() })))} data-v-fcf419b0><p class="text-gray-400 text-sm" data-v-fcf419b0> Don&#39;t have an account? `);
      ...
      _push(`</p></div><div class="relative flex items-center py-2" data-v-fcf419b0><div class="grow border-t border-white/10" data-v-fcf419b0></div><span class="shrink mx-4 text-zinc-500 text-[10px] uppercase tracking-widest font-bold" data-v-fcf419b0>Encrypted Session</span><div class="grow border-t border-white/10" data-v-fcf419b0></div></div><p class="text-center text-xs text-zinc-500 leading-relaxed" data-v-fcf419b0> Authorized personnel only. Sessions are logged and analyzed for regional compliance. </p></div></div><footer class="mt-8 flex justify-between items-center px-4" data-v-fcf419b0><div class="flex items-center gap-2" data-v-fcf419b0><div class="w-1.5 h-1.5 rounded-full bg-[#30cf43] shadow-[0_0_8px_#30cf43]" data-v-fcf419b0></div><span class="text-[10px] font-bold text-zinc-500 uppercase tracking-widest" data-v-fcf419b0>Ghost-Node Active</span></div><span class="text-[10px] font-mono text-zinc-600 italic-none" data-v-fcf419b0>v3.0.4-LITE</span></footer></main></div>`);
    };
  }
});
...
const login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fcf419b0"]]);

export { login as default };
//# sourceMappingURL=login-DmtUMv7P.mjs.map
