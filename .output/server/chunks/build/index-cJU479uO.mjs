import { _ as __nuxt_component_0, a as __nuxt_component_3 } from './Section-CuXq1Jhn.mjs';
import * as vue from 'vue';
import { defineComponent, resolveComponent, mergeProps, unref, withCtx, createVNode, useSlots, toRef, computed, toHandlers, renderSlot, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, ref, toRefs, normalizeProps, guardReactiveProps, useTemplateRef, isRef, useModel, watch, renderList, mergeModels, h, reactive, watchEffect, nextTick, normalizeStyle, toValue, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderSlot, ssrRenderClass, ssrRenderAttr, ssrRenderStyle } from 'vue/server-renderer';
import { u as useHead, O as useNuxtData, F as _sfc_main$8, v as useLocale, w as useAppConfig, x as useComponentUI, y as useForwardPropsEmits, z as reactivePick, B as usePortal, C as createReusableTemplate, D as tv, V as VisuallyHidden_default, e as useVModel, r as useEmitAsProps, g as useForwardExpose, s as Presence_default, P as Primitive, T as Teleport_default, _ as __nuxt_component_0$2, f as createContext, i as injectConfigProviderContext, K as useFormField, G as useFieldGroup, H as useComponentIcons, I as _sfc_main$e, J as _sfc_main$b, M as createRef, N as useForwardProps, d as unrefElement, t as tryOnBeforeUnmount, k as getActiveElement, A as AUTOFOCUS_ON_MOUNT, l as focusFirst, m as getTabbableCandidates, n as focus, p as AUTOFOCUS_ON_UNMOUNT, o as onKeyStroke, h as isNullish, c as createSharedComposable, L as looseToNumber, E as EVENT_OPTIONS, q as getTabbableEdges, j as createGlobalState } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_baseEngineActive = resolveComponent("baseEngineActive");
      const _component_baseHeaderAuth = __nuxt_component_0;
      const _component_UModal = _sfc_main$6;
      const _component_UButton = _sfc_main$8;
      const _component_baseQrCode = resolveComponent("baseQrCode");
      const _component_baseHeaderSection = __nuxt_component_3;
      const _component_baseTable = __nuxt_component_4;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen py-20 p-6 lg:py-18 relative overflow-hidden" }, _attrs))} data-v-ea06d367><div class="absolute top-0 right-0 w-150 h-150 bg-cyan-400 rounded-full blur-[200px] opacity-[0.03]" data-v-ea06d367></div><header class="max-w-350 mx-auto flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-6 relative z-10" data-v-ea06d367><div data-v-ea06d367><div class="flex items-center gap-3 mb-2" data-v-ea06d367>`);
      ...
      _push(`</div><div class="flex gap-4" data-v-ea06d367>`);
      ...
      _push(`</div></header><main class="max-w-350 mx-auto relative z-10" data-v-ea06d367><section class="flex flex-wrap justify-around gap-6 mb-12" data-v-ea06d367><!--[-->`);
      ssrRenderList({ "Total Intake": unref(leads)?.length ?? 0, "Active Leads": `${unref(status).allStatus.active.length}`, "New Leads": `${unref(status).allStatus.new.length}` }, (val, label) => {
        _push(`<div class="backdrop-blur-xl bg-white/2 border border-white/8 p-8 rounded-3xl w-full sm:w-62.5" data-v-ea06d367><p class="text-[10px] font-bold uppercase tracking-widest text-zinc-500 mb-4" data-v-ea06d367>${ssrInterpolate(label)}</p><p class="text-3xl font-bold tabular-nums" data-v-ea06d367>${ssrInterpolate(val)}</p></div>`);
      });
      _push(`<!--]--></section><div class="flex w-full" data-v-ea06d367><div class="space-y-6 w-full" data-v-ea06d367><div class="flex justify-between items-end mb-4" data-v-ea06d367>`);
      _push(ssrRenderComponent(_component_baseHeaderSection, { text: "Lead Tracking" }, null, _parent));
      _push(`</div><div class="backdrop-blur-xl bg-white/2 border border-white/8 rounded-[2.5rem] overflow-hidden w-full" data-v-ea06d367>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ea06d367"]]);

export { index as default };
//# sourceMappingURL=index-cJU479uO.mjs.map
