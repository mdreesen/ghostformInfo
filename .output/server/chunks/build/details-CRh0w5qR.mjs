import { a as useRoute, _ as __nuxt_component_0$2 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-[#0a0a0c] text-white p-6 lg:p-12 relative overflow-hidden font-sans" }, _attrs))}><div class="absolute top-[-20%] right-[-10%] w-200 h-200 bg-[#30cf43] rounded-full blur-[200px] opacity-[0.04]"></div><main class="max-w-5xl mx-auto relative z-10"><nav class="mb-12 flex justify-between items-center">`);
...
//# sourceMappingURL=details-CRh0w5qR.mjs.map
