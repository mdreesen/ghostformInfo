...
import { t as tryOnBeforeUnmount, e as createSharedComposable, i as injectConfigProviderContext, f as unrefElement, g as useVModel, h as createContext, j as useForwardExpose, P as Primitive, o as onKeyStroke, k as isNullish, l as createGlobalState, m as getActiveElement, A as AUTOFOCUS_ON_MOUNT, n as focusFirst, p as getTabbableCandidates, q as focus, r as AUTOFOCUS_ON_UNMOUNT, E as EVENT_OPTIONS, s as getTabbableEdges, v as useEmitAsProps, w as Presence_default, T as Teleport_default, x as useLocale, y as useAppConfig, z as useComponentUI, B as useForwardPropsEmits, C as reactivePick, D as usePortal, F as createReusableTemplate, G as tv, V as VisuallyHidden_default, H as _sfc_main$5, I as useRuntimeConfig, u as useHead, c as useNuxtData } from "../server.mjs";
import { hideOthers } from "aria-hidden";
import { defu } from "/Users/mdreesen/Documents/Programming/projects/ghostformInfo/node_modules/defu/dist/defu.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen py-20 p-6 lg:py-18 relative overflow-hidden" }, _attrs))} data-v-05600b5c><div class="absolute top-0 right-0 w-150 h-150 bg-cyan-400 rounded-full blur-[200px] opacity-[0.03]" data-v-05600b5c></div><header class="max-w-350 mx-auto flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-6 relative z-10" data-v-05600b5c><div data-v-05600b5c><div class="flex items-center gap-3 mb-2" data-v-05600b5c>`);
      ...
      _push(`</div><div class="flex gap-4" data-v-05600b5c>`);
      ...
      _push(`</div></header><main class="max-w-350 mx-auto relative z-10" data-v-05600b5c><section class="flex flex-wrap justify-around gap-6 mb-12" data-v-05600b5c><!--[-->`);
      ssrRenderList({ "Total Intake": unref(user)?.leads?.length ?? 0, "Active Leads": "WIP", "Conversion": "WIP" }, (val, label) => {
        _push(`<div class="backdrop-blur-xl bg-white/2 border border-white/8 p-8 rounded-3xl w-full sm:w-62.5" data-v-05600b5c><p class="text-[10px] font-bold uppercase tracking-widest text-zinc-500 mb-4" data-v-05600b5c>${ssrInterpolate(label)}</p><p class="text-3xl font-bold tabular-nums" data-v-05600b5c>${ssrInterpolate(val)}</p></div>`);
      });
      _push(`<!--]--></section><div class="flex w-full" data-v-05600b5c><div class="space-y-6 w-full" data-v-05600b5c><div class="flex justify-between items-end mb-4" data-v-05600b5c><h2 class="text-lg font-bold" data-v-05600b5c>Individual Personnel Tracking</h2></div><div class="backdrop-blur-xl bg-white/2 border border-white/8 rounded-[2.5rem] overflow-hidden w-full" data-v-05600b5c>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-05600b5c"]]);
export {
  index as default
};
//# sourceMappingURL=index-DsCvdecn.js.map
